...
V3 按 [架构设计实施稿](docs/架构设计实施稿.md) 分阶段建设。Phase 1 正式状态基础和 Phase 2 全市场历史行情底座已完成技术验收；Phase 2 实际覆盖 5,551/5,551 只 A 股并具备 RAW/QFQ/Factor、周/月聚合、公司行动、修订链和隔离 Worker。生产 V3 仍默认关闭，当前开发进入 Phase 3；详见 [工作状态](docs/工作状态.md) 与 [Phase 2 验收记录](docs/Phase2行情底座实施记录.md)。
