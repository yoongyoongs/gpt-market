...
V3 按 [架构设计实施稿](docs/架构设计实施稿.md) 分阶段建设。Phase 1 正式状态基础、Phase 2 全市场历史行情底座和 Phase 3 全市场 Feature Run、Universe Query、事实型 Market Regime 已完成技术验收；Phase 4 Evidence Ingestion 正在开发，数据闭环和首批 Core Provider 已完成，实体匹配、Job 与 READ API 尚待完成。Phase 5 至 Phase 11 尚未开始，生产 V3 仍默认关闭；详见 [工作状态](docs/工作状态.md)、[Phase 3 实施记录](docs/Phase3全市场特征实施记录.md) 与 [Phase 4 实施记录](docs/Phase4证据管道实施记录.md)。
