...
V3 按 [架构设计实施稿](docs/架构设计实施稿.md) 分阶段建设。Phase 1–6 已完成技术验收；Phase 7–10 已完成代码开发，尚未执行测试和 Architecture Gate，不能视为稳定版本。生产 V3 仍默认关闭；详见 [工作状态](docs/工作状态.md)及 Phase 7–10 实施记录。
