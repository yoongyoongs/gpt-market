...
5. [V3 技术架构设计](技术架构设计.md)
6. [V3 数据库设计](数据库设计.md)
7. [V3 详细设计](详细设计.md)
8. [V3 架构设计实施稿](架构设计实施稿.md)
9. [功能清单与开发状态](功能清单与开发状态.md)
10. [开发工作规范](开发规范.md)
11. 当前任务相关代码与测试
...
保存 V3 蓝图和两轮 GPT Review 原文。它们用于审计 Baseline 1.0 的形成过程，不是独立实施依据。若其内容与架构实施稿冲突，以架构实施稿为准。
